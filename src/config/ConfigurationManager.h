...
public:
    ...
    std::vector<ShaderConfig> getShadersByCategory(const std::string& category) const;
    ShaderConfig* getShaderConfig(const std::string& shaderName);
    
    // Parameter values
    void setParameter(const std::string& shader, const std::string& param, ConfigValue value);
    ConfigValue getParameter(const std::string& shader, const std::string& param) const;
    ConfigValue getParameterDefault(const std::string& shader, const std::string& param) const;
    ...
    using ConfigChangeCallback = std::function<void(const std::string& shader, 

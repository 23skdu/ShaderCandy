...
/**
 * GLSLWrapper provides a unified shader preamble for all Linux OpenGL backends.
 * It ensures consistency between standalone player, screensaver, and wallpaper
 * modes.
 */
class GLSLWrapper {
public:
  static std::string getPreamble(bool isGLES = false) {
    ...
    return version + std::string(R"GLSL(
#define PI 3.14159265359
#define TWO_PI 6.28318530718

// Common Uniforms (matching ShaderInterop.h)
...
vec3 Reinhard(vec4 x) {
    return x.rgb / (x.rgb + vec3(1.0));
}

...
inline void multiplyArrayNEON(float *dst, const float *a, const float *b,
                              size_t count) {
  size_t i = 0;
  for (; i + 3 < count; i += 4) {
...
inline void lerpArrayNEON(float *dst, const float *a, const float *b, float t,
                          size_t count) {
...
inline void multiplyArrayAVX2(float *dst, const float *a, const float *b,
                              size_t count) {
  size_t i = 0;
  for (; i + 7 < count; i += 8) {
...
inline void lerpArrayAVX2(float *dst, const float *a, const float *b, float t,
                          size_t count) {
...
inline void multiplyArray(float *dst, const float *a, const float *b,
                          size_t count) {
#if defined(USE_NEON)
...
inline void lerpArray(float *dst, const float *a, const float *b, float t,
                      size_t count) {
#if defined(USE_NEON)

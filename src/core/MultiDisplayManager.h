...
public:
    ...
    // Configuration
    void setDisplayShader(const std::string& displayId, const std::string& shaderName);
    ...
    void virtualToDisplay(float vx, float vy, 
    ...
    using DisplayChangeCallback = std::function<void(const std::vector<DisplayInfo>&)>;
...
namespace DisplayUtils {
    ...
    void getBoundingBox(const std::vector<DisplayInfo>& displays,

...
public:
    ...
    void setAudioData(float volume, float bass, float mid, float treble, float beat);
    void setGravity(float gravity) { uniforms_.gravity = gravity; }

    // Audio Reactivity
    void setAudioReactivityEnabled(bool enabled) { audioReactivityEnabled_ = enabled; }

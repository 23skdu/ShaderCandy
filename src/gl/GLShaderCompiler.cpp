...
GLShaderCompiler::~GLShaderCompiler() { shutdown(); }
...
void GLShaderCompiler::shutdown() { initialized_ = false; }

bool GLShaderCompiler::compileFromFile(const std::string &shaderPath,
...
unsigned int GLShaderCompiler::compileShaderSource(const std::string &source,
                                                   unsigned int type) {
